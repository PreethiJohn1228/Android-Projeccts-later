...
public class MainPagelaw extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mainpagelaw);
        ...
        db.addDet(new Laws(1234567891,"Criminal","Ram","Chennai","District Court",
        ...
        ImageButton b1=findViewById(R.id.imageButton10);
        ImageButton b2=findViewById(R.id.imageButton9);
