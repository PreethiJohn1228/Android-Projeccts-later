...
public class Update extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EditText e2=findViewById(R.id.editTextTextPersonName10);
        EditText e3=findViewById(R.id.editTextTextPersonName8);
        EditText e4=findViewById(R.id.editTextTextPersonName9);
        EditText txtDate = findViewById(R.id.editTextTextPersonName3);
        EditText txtDate1 = findViewById(R.id.editTextTextPersonName11);
        EditText e7=findViewById(R.id.editTextTextPersonName12);
        txtDate.setOnClickListener(view -> {
            ...
            datePickerDialog = new DatePickerDialog(Update.this, new DatePickerDialog.OnDateSetListener() {
