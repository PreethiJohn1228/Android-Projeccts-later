...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText lat=findViewById(R.id.editTextTextPersonName);
        EditText lon=findViewById(R.id.editTextTextPersonName2);
        Button get = findViewById(R.id.button);
        TextView addr= (TextView) findViewById(R.id.textView3);
