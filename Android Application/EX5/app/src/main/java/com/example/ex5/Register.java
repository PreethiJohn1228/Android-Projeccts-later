...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EditText e1 = findViewById(R.id.editTextTextPersonName4);
        EditText e2 = findViewById(R.id.editTextTextPersonName5);
        EditText e3 = findViewById(R.id.editTextTextPersonName6);
